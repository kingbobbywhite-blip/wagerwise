...
export function SlipCard({ slip, appId, modeId }: { slip: BuiltSlip; appId: string; modeId: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 md:grid-cols-4">
        <StatTile label="All hit" value={pct(e.pAllHit)} hint="Modelled, correlation included." />
      ...
      <Collapsible open={open} onOpenChange={setOpen} className="mt-3">
        ...
        <CollapsibleContent className="space-y-3 pt-2">
          ...
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            Simulated {e.simulations.toLocaleString()} times. Full Kelly here is {pct(e.kelly)} of bankroll; the app
            stakes a fraction of that on purpose.
          </p>
        </CollapsibleContent>
      </Collapsible>
